...
class UtilsTestCase(TestCase):
    ...
    def test_country_count(self):
        ...
        for row in count_list:
            ...
            self.assertEqual(count_dict["United States"], 4, "Count for United States shoud be 4")
            self.assertEqual(count_dict["Canada"], 2, "Count for Canada shoud be 2")
            self.assertEqual(count_dict["United Kingdom"], 1, "Count for United Kingdom shoud be 1")
